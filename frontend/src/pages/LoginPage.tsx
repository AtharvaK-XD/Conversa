...
export const LoginPage: React.FC = () => {
  ...
  return (
    <PageTransition>
      ...
      <div className="w-full min-h-screen bg-transparent flex flex-col items-center justify-center p-4 selection:bg-blue-600 selection:text-white font-sans relative overflow-x-hidden">
        
        {/* MAIN AUTH CARD CONTAINER - Sliding Blue Theme Overlay Card */}
        <div className="relative w-full max-w-3xl min-h-[480px] md:min-h-[500px] glass-canvas rounded-[24px] overflow-hidden flex flex-col md:flex-row z-10">
