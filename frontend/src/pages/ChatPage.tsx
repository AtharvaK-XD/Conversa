...
export const ChatPage: React.FC = () => {
  ...
  return (
    <PageTransition>
      <div className="w-full flex-grow flex flex-col h-screen max-h-screen overflow-hidden bg-transparent text-[#18181B] relative">
          ...
          <div className="max-w-4xl mx-auto w-full flex flex-col gap-3">
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <button
                ...
                className="font-mono text-xs font-semibold uppercase tracking-wider px-4 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-white transition-all duration-200 flex items-center gap-1.5 cursor-pointer shadow-sm hover:shadow-md"
              >
